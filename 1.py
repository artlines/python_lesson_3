...
# dict, ключами которого являются слова, а значениями их количество появлений в тексте
words_count = dict.fromkeys(words_lower, 0)
for i in words_lower:
    words_count[i] += 1
print(words_count)

# 5 наиболее часто встречающихся слов
words_count_most_often = list(words_count.values())
words_count_most_often.sort(reverse=True)
words_count_most_often = words_count_most_often[:5]

for key, value in words_count.items():
    if value in words_count_most_often:
        print(key)

# вывести количество разных слов в тексте
words_different = set(words_lower)
print(words_different)

# лемматизация
morph = pymorphy2.MorphAnalyzer()
words = list(words_different)
for word in words:
